      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-evenly items-center m-auto flex-col lg:flex-row">
          <h2 className="text-4xl font-semibold text-gray-800 mb-12 text-center px-5 md:text-6xl lg:w-1/2 lg:text-left lg:text-7xl">
            Our <span className="text-blue-500 font-serif">happy</span> clients
            say about us
          </h2>
          <p className="text-gray-500 text-center mb-12 px-5 lg:w-1/2 lg:text-left">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit.
            Reiciendis, nihil tempora autem aliquam repellendus saepe doloribus
            repudiandae vitae sint magni beatae debitis quisquam eveniet? Facere
            odit aut quod sit praesentium.
          </p>
        </div>
