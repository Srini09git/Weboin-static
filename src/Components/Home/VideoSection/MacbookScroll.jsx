...
import { cn } from "./ExampleComponent";
import weboinvedio from '../../../../public/Video/Weboindmvideo.mp4'
import {
  IconBrightnessDown,
  IconBrightnessUp,
...
export const MacbookScroll = ({
  ...
  return (
    (<div
      ref={ref}
      className="min-h-screen md:min-h-[200vh]  flex flex-col items-center py-0  justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-[0.75]">
      <motion.h2
        style={{
  ...
  return (
    (<div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        <video
          src={weboinvedio} // The source of your video file
