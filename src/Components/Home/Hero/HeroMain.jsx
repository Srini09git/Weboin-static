...
const Hero = () => {
    return (
        ...
        <div
            className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-blue-500 via-pink-200 to-blue-200 dark:from-gray-800 dark:via-gray-700 dark:to-red-800 min-h-screen">
            {/*  <a href=""
            ...
            <h1
                className="mx-auto max-w-4xl font-display text-3xl md:text-5xl font-bold tracking-normal text-white-300 dark:text-gray-300 sm:text-7xl">
                ...
                <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
                    ...
                    <span className="relative">WEBOIN</span>
                </span>
            </h1>
