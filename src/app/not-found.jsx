...
const notfound = () => {
  return (
    <div class="flex items-center flex-col justify-center lg:flex-row py-28 px-6 md:px-24 md:py-20 lg:py-32 gap-16 lg:gap-28">
      ...
      <div class="w-full lg:w-1/2">
        <h1 class="py-4 text-3xl lg:text-4xl font-extrabold text-gray-800 dark:text-white">Looks like youve found the doorway to the great nothing</h1>
        <p class="py-4 text-base text-gray-800 dark:text-white">The content youre looking for doesn Either it was removed, or you mistyped the link.</p>
